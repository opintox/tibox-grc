    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "situation": "Andrea Salgado, del equipo de comunicaciones, tiene tres pantallas: en una, los comentarios en Instagram pasando de 'no me carga' a 'esta empresa es un desastre'; en otra, el chat de atención a clientes con cola de 40 minutos; en la tercera, un mensaje del gerente comercial pidiéndole que 'no diga nada todavía'.\n\nSon las 12:45 y el silencio ya lleva una hora. Andrea sabe que en ese vacío la gente escribe su propia versión, y que a esta altura hay quien está diciendo que les robaron los datos de la tarjeta.",
          "options": [
      ...
      "questions": [
        {
          ...
          "situation": "Es martes por la mañana en plena semana de cierre contable y el área de Finanzas trabaja contra reloj. A las 09:12 entra un mensaje al canal de soporte y a Simón Lagos, de mesa de ayuda TI, se le derrama el café encima del mousepad cuando lo lee. Es Camila Reyes, analista de conciliaciones, y escribe rápido, sin puntos: recibió un correo con el asunto «Verificación urgente de cuenta corriente», el logo del banco de la empresa y un enlace que abrió sin pensarlo mucho porque estaba esperando justamente una gestión bancaria.\n\nIngresó su usuario y su contraseña. La página se recargó y le pidió el código del segundo factor. Lo escribió. La página se lo pidió de nuevo. Ahí se dio cuenta de que algo no calzaba y cerró todo.\n\nSimón hace la cuenta con el trapo todavía en la mano: han pasado quince minutos desde el primer clic, y nadie sabe todavía si alguien está usando esas credenciales en este momento. Revisa el buzón compartido y se le aprieta un poco más el estómago: el mismo correo llegó a otras seis casillas del área, todas a las 09:03, y ninguna de esas seis personas ha dicho una palabra.",
          "options": [
      ...
      "questions": [
        {
          ...
          "situation": "Catorce minutos después del mensaje de Camila, Simón le escribe a Daniela Contreras, analista de seguridad de la información, algo que empieza con «oye, esto se puso feo»: el registro de accesos deja de ser una sospecha y pasa a ser un hecho. Hay un inicio de sesión exitoso con la cuenta de Camila desde una dirección IP que no corresponde a ninguna oficina ni a ningún proveedor conocido, y ocurrió tres minutos después de que ella entregara sus datos.\n\nDaniela abre el mapa de permisos antes que cualquier otra cosa, y ahí está el detalle que cambia el peso del caso. Camila no es una usuaria cualquiera: su cuenta puede cargar pagos a proveedores en el ERP, y desde su casilla salen y llegan las confirmaciones de transferencia del área. Es semana de cierre, así que hoy circulan más órdenes de pago que un día normal.\n\nDaniela junta al equipo en la sala. La primera decisión no es técnica: es decidir qué tan grave es esto, porque de esa etiqueta depende a quién se despierta, qué recursos se movilizan y con qué urgencia.",
          "options": [
      ...
      "questions": [
        {
          ...
          "situation": "Mientras Daniela termina de clasificar, Simón sigue con la lupa puesta en la casilla de Camila y encuentra lo que faltaba. Hay una sesión abierta en este preciso momento con su cuenta. Y hay algo más, algo que lo hace acercar la silla a la pantalla: una regla de reenvío automático creada hace cuatro minutos, que envía copia a una dirección externa de todo correo que contenga las palabras «factura», «transferencia» o «pago», y que además lo marca como leído y lo mueve a una carpeta que nadie mira.\n\nSimón entiende lo que significa antes de terminar de leerlo: el atacante ya no depende de la contraseña. Tiene la sesión viva y tiene el flujo de correo del área. Aunque Camila cambiara su clave ahora mismo, seguiría recibiendo copia de cada orden de pago que entre.\n\nEn la pantalla, el reloj del cierre contable sigue corriendo y las primeras órdenes del día ya están circulando.",
          "options": [
      ...
      "questions": [
        {
          ...
          "situation": "A las 10:05 Simón mira su lista y tacha los primeros tres puntos: la cuenta de Camila tiene contraseña nueva, el segundo factor reinscrito desde cero y todas las sesiones cortadas. La regla de reenvío ya no existe, aunque guardó una copia como evidencia antes de borrarla.\n\nCamila lleva media hora sin poder trabajar y pregunta por el canal cuándo puede volver a entrar. Su jefatura pregunta lo mismo, con más apuro en el tono: hay pagos que deben quedar cursados hoy.\n\nSimón siente la tentación de devolver el acceso ahí mismo. Pero se acuerda de que la regla de reenvío apareció recién a la cuarta revisión, no a la primera, y todavía no ha mirado si el atacante dejó algo más: una delegación de buzón, una aplicación autorizada con permisos permanentes o un dispositivo enrolado a nombre de Camila. Cualquiera de esas tres sobrevive intacta a un cambio de contraseña.",
          "options": [
      ...
      "questions": [
        {
          ...
          "situation": "Dos horas y media después del primer clic, Daniela tiene el balance sobre la mesa. No hubo transferencias ni movimientos en el ERP. La casilla de Camila quedó limpia, revisada permiso por permiso por Simón. Ella volvió a trabajar a las 10:40 y el cierre contable sigue su curso como si nada, aunque ahora revisa dos veces cada correo que le llega.\n\nDel correo original se confirmó que llegó a siete casillas en total. Una persona hizo clic. Las otras seis nunca lo reportaron: dos lo borraron, tres no lo vieron y una lo dejó ahí, sin abrirlo, por si acaso.\n\nEl equipo quiere dar el caso por terminado y volver a la operación. Daniela sabe que lo que decida ahora es lo único que va a quedar escrito de todo este martes.",
          "options": [
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "situation": "Cristián Bulnes, abogado interno, llega a la sala con dos carpetas: la póliza de ciberseguro y la matriz de datos por sistema. La nota de rescate incluye un enlace a un chat con los atacantes y alguien de operaciones ya preguntó, medio en broma, cuánto están pidiendo.\n\nCristián pone las dos carpetas sobre la mesa. Sabe que la póliza tiene un plazo de aviso de 48 horas, que hablar con los atacantes sin autorización puede invalidarla, y que en el servidor de operaciones hay contratos con datos de personas.",
          "options": [
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "situation": "Josefa Aravena, del equipo de comunicaciones, baja un piso y ve lo que pasa cuando nadie dice nada: gente parada en los pasillos, teléfonos grabando la pantalla del servidor con la nota de rescate, y un grupo de WhatsApp interno donde ya circula la palabra \"hackeo\" con tres audios encima.\n\nUn cliente importante acaba de llamar al ejecutivo comercial preguntando por qué no le llegó la factura de la mañana. Josefa tiene quince minutos antes de que ese pantallazo salga de la empresa.",
          "options": [
